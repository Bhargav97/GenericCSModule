...
public class ArrivalsFragment extends Fragment {
    ...
    static RVCRAdapter rvAdapter;
    static RecyclerViewClickListener listener;
    static List<RVCouchReq> dataList;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        RelativeLayout rl = v.findViewById(R.id.imgHeadingExplore);
        rl.setVisibility(View.GONE);
        ((MainActivity) getActivity()).setActionBarTitle("Arrivals' Status");
    ...
    public void getData() {
        ...
        db.collection("requests").whereEqualTo(COUCH_OWNER_UID_KEY, UID).whereEqualTo(REQUEST_HOSTAPPROVED_KEY,true).whereEqualTo(REQUEST_HOSTREJECTED_KEY,false).get()
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            for (QueryDocumentSnapshot document : task.getResult()) {
                                ...
                                nameData.add(document.get(REQUEST_GUEST_NAME_KEY).toString());
