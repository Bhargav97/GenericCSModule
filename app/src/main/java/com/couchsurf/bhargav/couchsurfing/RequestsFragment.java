...
public class RequestsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       ...
       ((MainActivity) getActivity()).setActionBarTitle("Pending Requests' Status");
    ...
    public void getData() {
        ...
        db.collection("requests").whereEqualTo(REQUEST_GUEST_ID_KEY, UID).whereEqualTo(REQUEST_HOSTREJECTED_KEY,false).whereEqualTo(REQUEST_HOSTAPPROVED_KEY,false).get()
